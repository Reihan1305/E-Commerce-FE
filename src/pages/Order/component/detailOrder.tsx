...
import TrackingShipmentModal from "../atom/trackingShipmentModal";
...
const DetailOrder = () => {
    ...
    return (
        <>
            ...
            <TrackingShipmentModal open={open} onClose={handleClose} />
            ...
            <Box sx={{
                ...
                >
                    ...
                    >
                        ...
                        >
                            <AccordionSummary
                                expandIcon={<ExpandMoreIcon sx={{ fill: "#0086B4" }} />}
                                sx={{
                                    width: "210px",
                                    color: "#0086B4",
                                    fontWeight: 600,
                        ...
                        <Box sx={{ display: "flex", flexDirection: "column" }}>
                            ...
                            >
                                ...
                                <Button
                                    onClick={() => handleOpen()}
                                    sx={{
                                        display: data.status === "Dalam Pengiriman" || data.status === "Pesanan Selesai" ? "block" : "none"
                                    }}
                                >
                                    Lacak Pengiriman
                                </Button>
